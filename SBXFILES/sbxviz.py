...
df = pd.DataFrame(dat, columns="year", "total_waste", "directops_discarded",
                  "licensedstores_discarded", "customers_discarded",
                  "packagingmaterial", "total_previous_year", "percent_change")
print(df)
